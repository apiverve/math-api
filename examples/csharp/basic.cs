...
namespace APIVerve.Examples
{
    class MathCalculatorExample
    {
        ...
        {
            Console.WriteLine("📤 Calling Math Calculator API...\n");

            var result = await CallMathCalculatorAPI();
