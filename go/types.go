...
// Request contains the parameters for the Math Calculator API.
//
// Parameters:
...
type Request struct {
	...
	B int `json:"b,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Math Calculator API.
...
// InputData represents the input object.
