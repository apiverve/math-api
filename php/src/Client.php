...
/**
 * Client for the Math Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/math?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/math';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MathClient] {$message}\n";
        }
    }
}
