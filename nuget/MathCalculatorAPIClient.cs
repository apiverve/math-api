...
namespace APIVerve.API.MathCalculator
{
    ...
    /// <summary>
    /// Client for the MathCalculator API
    /// </summary>
...
#endif
    {
        ...
        {
            { "operation", new ValidationRule { Type = "string", Required = true } },
            { "a", new ValidationRule { Type = "number", Required = true } },
            { "b", new ValidationRule { Type = "number", Required = false } }
        };
        ...
        private void ValidateParams(MathCalculatorQueryOptions options)
        {
