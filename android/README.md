...
```gradle
dependencies {
    implementation 'com.github.apiverve:math-api:1.1.12'
}
```
...
```java
import com.apiverve.math.MathCalculatorAPIClient;
import com.apiverve.math.APIResponse;
import com.apiverve.math.APIException;

// Initialize the client
MathCalculatorAPIClient client = new MathCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/math](https://docs.apiverve.com/ref/math)
...
- **Documentation:** [https://docs.apiverve.com/ref/math](https://docs.apiverve.com/ref/math)
- **Issues:** [GitHub Issues](https://github.com/apiverve/math-api/issues)
